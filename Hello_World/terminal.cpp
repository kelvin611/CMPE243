...
bool terminalTask::taskEntry()
{
    ...
    cp.addHandler(displaySensor,   "sensor",  "sensor temperature - displays current termperature value \nsensor light - displays current light value \nsensor acceleration - displays the acceleration values in x,y,z axis\n");
